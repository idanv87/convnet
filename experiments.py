...
# exp1(polygons[5],models[-1],15,225)
exp2(polygons[5],models[-1],40,57)
...
# Setting the values for all axes.
    ...
    axs[2,0].plot(vertices[:, 0], vertices[:, 1], 'b-', marker='o')

    
    vertices=t_polygons[7]
    axs[2,1].plot(vertices[:, 0], vertices[:, 1], 'b-', marker='o')

    
    vertices=t_polygons[8]
    axs[2,2].plot(vertices[:, 0], vertices[:, 1], 'b-', marker='o')
